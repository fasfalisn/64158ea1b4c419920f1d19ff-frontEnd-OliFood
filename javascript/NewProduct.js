let apiProductApi = new TempApi.ProductApi();import TempApi from '../src/index';let product = new TempApi.Product();document.getElementById('i0ydy').onclick = (event) => {
...
document.getElementById('i0cmaj').onclick = (event) => {
    event.preventDefault();
    product['productName'] = document.querySelector("[annotationname = 'productName']").value;product['productPrice'] = document.querySelector("[annotationname = 'productPrice']").value;product['productCategory'] = document.querySelector("[annotationname = 'productCategory']").value;product['productImage'] = {
      ...
      product['productUnit'] = document.querySelector("[annotationname = 'productUnit']").value;apiProductApi.createproduct( product, (error, data, response) => { if (error) {console.error(error);} else { console.log('API called successfully. Returned data: ' + data); {   location.href= '/MyProducts' ;}}});};window.onload = () => {};